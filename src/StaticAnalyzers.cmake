...
macro(enable_include_what_you_use)
  ...
  if(INCLUDE_WHAT_YOU_USE)
    if(WARNINGS_AS_ERRORS)
      # On versions from 0.19 onward and CMake 3.16, passing --error allows CMake
      # to fail if IWYU requests changes, in older versions the flag is ignored
      # (with a warning)
      set(INCLUDE_WHAT_YOU_USE_ARGS "--error")
    endif()
    set(CMAKE_C_INCLUDE_WHAT_YOU_USE ${INCLUDE_WHAT_YOU_USE} ${INCLUDE_WHAT_YOU_USE_ARGS})
    set(CMAKE_CXX_INCLUDE_WHAT_YOU_USE ${INCLUDE_WHAT_YOU_USE} ${INCLUDE_WHAT_YOU_USE_ARGS})
  else()
